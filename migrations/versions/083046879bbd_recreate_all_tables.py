...
Revision ID: 083046879bbd
Revises: 1f0b7f79cf4f
Create Date: 2025-08-22 12:50:46.925139
...
revision = '083046879bbd'
down_revision = '1f0b7f79cf4f'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('payor_type', sa.String(length=50), nullable=True),
    sa.Column('payor_detail', sa.String(length=100), nullable=True),

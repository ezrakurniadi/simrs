        ...
        <div class="col-md-6">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        {{ form.marriage_status.label(class="form-label") }}
                        {{ form.marriage_status(class="form-select") }}
                        {% if form.marriage_status.errors %}
                            <div class="text-danger">
                                {% for error in form.marriage_status.errors %}
                                    <small>{{ error }}</small>
                                {% endfor %}
                            </div>
                        {% endif %}
        ...
        <div class="col-md-6">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        {{ form.preferred_communication.label(class="form-label") }}
                        {{ form.preferred_communication(class="form-control") }}
